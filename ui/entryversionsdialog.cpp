...
void EntryVersionsModel::disable(){
	beginResetModel();
	...
	entryVersions(new EntryVersionsModel(entry, this))
{
	...
	connect(entryVersions, &EntryVersionsModel::disabled, this, &QWidget::setDisabled);
	connect(ui->treeView->selectionModel(), SIGNAL(currentChanged(QModelIndex,QModelIndex)),
			this, SLOT(currentChanged(QModelIndex,QModelIndex)));
	connect(entryVersions, &EntryVersionsModel::rowsInserted, this, &EntryVersionsDialog::itemCountChanged);
	connect(entryVersions, &EntryVersionsModel::rowsRemoved, this, &EntryVersionsDialog::itemCountChanged);
}
...
void EntryVersionsDialog::itemCountChanged(){
